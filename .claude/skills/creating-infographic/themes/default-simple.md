# デフォルト 1 カラムテーマ（グラフィックレコーディング風）

グラフィックレコーディング風のデフォルトテーマを 1 カラム構成にしたレイアウト。手書き風の要素とカラフルな配色で、読みやすく親しみやすいインフォグラフィックを作成します。

## カラーパレット

```xml
<palette name="default-single-column">
...
```css
/* Default Single Column Theme Base Styles */
:root {
  --fashion-1: #593C47;
  --fashion-2: #F2E63D;
  --fashion-3: #F2C53D;
